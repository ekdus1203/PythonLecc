...
#         가상머신(Virtual Machine), 공통언어환경(Commom Language Runtime(CLR)
...
# 2) 파이썬 라이브러리
#     ; 미리 자주쓰는 기능을 만들어 놓은 것
#         파이썬 코드 자체가 곧 실행파일이자 라이브러리
#         라이브러리
#         a) 모듈 : *.py 파일
#         b) 패키지 : 폴더 구조로 된 py파일들의 집합합
